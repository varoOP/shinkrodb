...
type Service interface {
	CleanCache(ctx context.Context, rootDir string, dbPath string, animeRepo domain.AnimeRepository, anidbPath domain.AnimePath) error
}
...
func (s *service) CleanCache(ctx context.Context, rootDir string, dbPath string, animeRepo domain.AnimeRepository, anidbPath domain.AnimePath) error {
